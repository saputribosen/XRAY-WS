...
```
apt update -y && apt upgrade -y && apt install -y wget screen && wget -q https://raw.githubusercontent.com/saputribosen/XRAY-WS/main/setup.sh && chmod +x setup.sh && screen -S setup ./setup.sh
```
